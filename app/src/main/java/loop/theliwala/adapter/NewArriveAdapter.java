...
public class NewArriveAdapter extends RecyclerView.Adapter<NewArriveAdapter.ViewHolder> {
...
//    ProductListFragment productListFragment;
    ...
    public NewArriveAdapter(Context context, List<Data> productData) {
...
//        this.productListFragment = productListFragment;
    ...
    @Override
    public NewArriveAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_bestsell_list, viewGroup, false);
        return new NewArriveAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final NewArriveAdapter.ViewHolder viewHolder, final int position) {
    ...
    private void checkDataQuntity(NewArriveAdapter.ViewHolder viewHolder, int position) {
...
//        productListFragment.checkBasketExistsDataOrNot();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            linearLayout_addSub = (LinearLayout) view.findViewById(R.id.linearLayout_addSub);
