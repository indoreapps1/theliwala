...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mLineOrientation = typedArray.getInt(R.styleable.timeline_style_lineOrientation, 0);
        ...
        if(mMarker == null) {
            mMarker = mContext.getResources().getDrawable(R.drawable.ic_marker_inactive);
        }
