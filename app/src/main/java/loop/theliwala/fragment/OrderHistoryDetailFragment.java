...
public class OrderHistoryDetailFragment extends Fragment {
    ...
    TextView tv_specialDiscount, tv_gst, total_gst,
            ...
            tv_discount, tv_discount_rupees_icon, tv_orderPlaced, tv_Discount_charges, tv_promocode, tv_promocode_value, storeName;
...
//
    ...
    private void init() {
        ...
        rootActivity.setScreenTitle("Order History");
